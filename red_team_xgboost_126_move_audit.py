...
def run_xgboost_audit(seed=0, noise_std=0.0, guillotine=False, test_name="BASELINE"):
    ...
    df_returns = df_core[['ds', 'vustx_close', 'gld_close', 'hg_close', 'vix_close', 'move_close', 'skew_zscore_252', 'vix_vxv_ratio_z', 'sent_0dte_repression_z']].copy()
    ...
    df_returns['move_vix_ratio'] = df_returns['move_close_prev'] / df_returns['vix_close_prev']
    df_returns['move_vix_ratio_z_63'] = (df_returns['move_vix_ratio'] - df_returns['move_vix_ratio'].rolling(63).mean()) / df_returns['move_vix_ratio'].rolling(63).std()
