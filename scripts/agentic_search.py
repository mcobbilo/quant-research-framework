...
class SearchableAgenticStrategy:
    ...
    def evaluate(self, row):
        ...
        recursive_feats = (self.action_history[-2:] + [0.5, 0.5])[:2] if self.config.get("recursive") else [0.5, 0.5]
...
def main():
    ...
    hypotheses = [
        {"name": "H11: Volatility-Adjusted Entry", "convex_vix": True, "kelly_multiplier": 1.2},
        {"name": "H12: Industrial Momentum (CGR)", "industrial_gate": True, "kelly_multiplier": 1.3},
        {"name": "H13: Convex VIX Rescaling", "convex_vix": True, "kelly_multiplier": 1.5},
        {"name": "H14: Time-Gated Recovery", "cooldown": 5, "kelly_multiplier": 1.4},
        {"name": "H15: Deep Consensus Validation", "deep_consensus": True, "kelly_multiplier": 1.6},
        {"name": "H16: Low-Vol Danger Signal", "industrial_gate": True, "kelly_multiplier": 1.7},
        {"name": "H17: Multi-Timeframe Trend", "trend_filter": True, "kelly_multiplier": 1.8},
        {"name": "H18: Innovation-Gated Exit", "akf_exit": True, "kelly_multiplier": 1.9},
        {"name": "H19: Recursive Feedback", "recursive": True, "kelly_multiplier": 2.0},
        {"name": "H20: The Synthetic Winner", "composite": True, "kelly_multiplier": 2.2, "convex_vix": True, "industrial_gate": True},
    ]
    ...
    for h in hypotheses:
        ...
        try: strat.council.load_weights()
        except: pass
        
        ret, sharpe = run_backtest(strat, df)
        results.append({"Hypothesis": h['name'], "Return": f"{ret:.2f}%", "Sharpe": f"{sharpe:.2f}"})
