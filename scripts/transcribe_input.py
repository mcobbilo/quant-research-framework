...
def transcribe(file_path):
    ...
    console.print(f"[blue]Transcribing {file_path} using faster-whisper (base)...[/blue]")
    ...
    console.print(f"[green]Detected language '{info.language}' with probability {info.language_probability:.2f}[/green]")
