...
def run_xgboost_audit(seed=0, noise_std=0.0, guillotine=False, test_name="BASELINE"):
    ...
    df_returns = df_core[['ds', 'vustx_close', 'gld_close', 'hg_close', 'vix_close']].copy()
    ...
    for idx, row in df_cont.iterrows():
        ...
        # VIX Panic Buy Override
        vix_panic_override = (row['vix_close_prev'] > 20.0)
