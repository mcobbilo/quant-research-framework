...
def run_xgboost_audit(seed=0, noise_std=0.0, guillotine=False, test_name="BASELINE"):
    ...
    df_returns = df_core[['ds', 'vustx_close', 'gld_close', 'hg_close', 'vix_close', 'skew_zscore_252', 'vix_vxv_ratio_z', 'sent_0dte_repression_z', 'nya200r']].copy()
    ...
    for idx, row in df_cont.iterrows():
        ...
        # Breadth Capitulation Override (SUPREME)
        breadth_capitulation = (row['nya200r'] < 0.10)
