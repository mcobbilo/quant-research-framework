...
def run_causal_audit():
    ...
    df['SIGMA_HAT'] = (df['G_LOW_S_L'] * mu_low + 
    ...
    df['PI'] = df['M'] * (sigma_target / (df['SIGMA_HAT'] + 1e-8)) * (1.0 / df['SQRT_RV_L'])
    ...
    if sharpe > 0.50:
        ...
        print("[AUDIT_FAIL] Lookahead bias detected in original. New Sharpe is significantly lower.")
