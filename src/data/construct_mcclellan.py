...
def build_mcclellan():
    ...
    save_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'data', 'mcclellan_sp500.csv')
    os.makedirs(os.path.dirname(save_path), exist_ok=True)
    df.to_csv(save_path)
    
    print(f"[MCO Matrix] McClellan Oscillator (Synthetic SP500) successfully compiled!")
