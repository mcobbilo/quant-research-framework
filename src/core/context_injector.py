class DynamicContextInjector:
    ...
    def query_macro_layer(self, date_str, z_score):
        ...
        print(
            f"   -> VIX Z-Score registered at {z_score:.2f} Sigma. Initiating Tier-3 Progressive Context Load."
        )
        print(
            "   -> Budget Constraints Active: Sourcing localized 3-day Federal Reserve & Sentiment news to append to LLM Memory..."
        )
