...
try:
    ...
    print(
        "FATAL: 'sentence_transformers' is not installed. Ensure dependencies are satisfied."
    )
    sys.exit(1)
...
def vectorize():
    ...
    with open(
        "/Users/milocobb/Desktop/Recent Swarm Papers/quant_framework/src/memory/strategies_rag/strategies_rag_corpus.json",
        "r",
    ) as f:
        corpus = json.load(f)
