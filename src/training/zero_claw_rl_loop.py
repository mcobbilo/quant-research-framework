...
def evaluate_signal(user_reply):
    ...
    negative_patterns = [r'\bno\b', r'\bwrong\b', r'\bstop\b', r'\bdon\'t\b', r'\bincorrect\b', r'\binstead\b', r'\bfix\b']
    positive_patterns = [r'\bperfect\b', r'\blooks good\b', r'\byes\b', r'\bexactly\b', r'\bcorrect\b']
...
def process_log_line(line):
    ...
    try:
        ...
        user_text = data.get('content', '') or data.get('user', '') or data.get('message', '') or data.get('text', '')
