...
# API Routes
@app.post("/train/rl_loop", summary="Trigger Asynchronous RL Training", tags=["Training"])
...
@app.post("/execute/backtest", summary="Trigger Full Tactical Backtest", tags=["Execution"])
...
@app.post("/execute/market_order", summary="Synchronous Live Market Order", tags=["Execution"])
...
@app.get("/task_status/{task_id}", summary="Check Celery Task Status", tags=["Monitoring"])
