...
def clean():
    ...
    if os.path.exists(MEMORY_PATH):
        ...
        for line in lines:
            ...
            if line.startswith("Fact:") or line.startswith("Error: _cpce") or line.startswith("Error: Unexpected") or line.strip() == "":
    ...
    print(f"Smart Cleanup successful. MEMORY.md purged of traceback garbage. CURIOSITY.md re-queued {restored_count} explicit failures.")
