...
def main():
    ...
    print(
        f"[Regime Backtest] Loaded {len(df)} operational business days. Attaching native algorithmic geometries..."
    )
    ...
    print(
        "[Regime Backtest] Initializing MetaStrategyClassifier (Encyclopedia + Regime Routing)..."
    )
    ...
    print(
        f"Meta-Classifier      | Total Return: {strat_total_return:>8,.2f}% | Sharpe Ratio: {strat_sharpe:.2f}"
    )
    print(
        "==========================================================================\n"
    )
