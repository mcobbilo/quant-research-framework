...
def generate_report():
    ...
    slippage_cost = 0.001
    results_df["Trade_Penalty"] = (
        results_df["Allocation"].diff().fillna(0).abs() * slippage_cost
    )
    results_df["Strategy_Ret"] = (
...
"""
    with open(
        "/Users/milocobb/.gemini/antigravity/brain/86f8d6d6-545f-43de-8268-7b50b6d1c47a/walk_forward_backtest.md",
        "w",
    ) as f:
        f.write(md)
