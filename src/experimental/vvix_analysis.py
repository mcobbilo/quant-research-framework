...
def analyze_vvix():
    ...
    for col in feature_cols:
        ...
        out_lines.append(
            f"-> Fwd  5-Day Return: {top_50['Fwd_5D'].mean() * 100:>6.2f}%  (Win Rate: {(top_50['Fwd_5D'] > 0).mean() * 100:.1f}%)"
        )
        out_lines.append(
            f"-> Fwd 10-Day Return: {top_50['Fwd_10D'].mean() * 100:>6.2f}%  (Win Rate: {(top_50['Fwd_10D'] > 0).mean() * 100:.1f}%)"
        )
        out_lines.append(
            f"-> Fwd 20-Day Return: {top_50['Fwd_20D'].mean() * 100:>6.2f}%  (Win Rate: {(top_50['Fwd_20D'] > 0).mean() * 100:.1f}%)"
        )
        out_lines.append(
            f"-> Fwd 60-Day Return: {top_50['Fwd_60D'].mean() * 100:>6.2f}%  (Win Rate: {(top_50['Fwd_60D'] > 0).mean() * 100:.1f}%)\n"
        )
        ...
        out_lines.append(
            f"-> Fwd  5-Day Return: {bottom_50['Fwd_5D'].mean() * 100:>6.2f}%  (Win Rate: {(bottom_50['Fwd_5D'] > 0).mean() * 100:.1f}%)"
        )
        out_lines.append(
            f"-> Fwd 10-Day Return: {bottom_50['Fwd_10D'].mean() * 100:>6.2f}%  (Win Rate: {(bottom_50['Fwd_10D'] > 0).mean() * 100:.1f}%)"
        )
        out_lines.append(
            f"-> Fwd 20-Day Return: {bottom_50['Fwd_20D'].mean() * 100:>6.2f}%  (Win Rate: {(bottom_50['Fwd_20D'] > 0).mean() * 100:.1f}%)"
        )
        out_lines.append(
            f"-> Fwd 60-Day Return: {bottom_50['Fwd_60D'].mean() * 100:>6.2f}%  (Win Rate: {(bottom_50['Fwd_60D'] > 0).mean() * 100:.1f}%)\n"
        )
