...
def run_strategy_j():
    ...
    df['Strat_Growth'] = (1 + df['Net_Returns'].fillna(0) + df['Cash_Yield'].fillna(0)).cumprod()
    ...
    print(f" [ALGORITHM] Strategy J:    ${(10000 * strat_final):,.2f}  Return: {strat_final*100-100:>6.1f}% | Max DD: {strat_max_dd:>6.1f}%")
    print("=======================================================\n")
