...
def run_strategy_j():
    ...
    positions = np.ones(len(df)) # Baseline 1.0x SPY Trajectory
    ...
    for i in range(len(df)):
        ...
        if in_trade:
            positions[i] = 2.0 # Engage 2.0x Margin deployment
            current_hold += 1
    ...
    # Imposing Hard Red-Team Friction Models
    ...
    print("=======================================================")
    print(f" Entry Protocol:  Buy identically on Top 100 PPO Extrema dates.")
    print(f" Exit Protocol:   Sell when VIX_TNX_PPO_7 structurally recovers (<= 0.0)")
    ...
    print(f" [ALGORITHM] Strategy J:    ${(10000 * strat_final):,.2f}  ({strat_final*100-100:.1f}%)")
    print("=======================================================\n")
