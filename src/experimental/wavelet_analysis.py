...
def analyze_wavelet():
    print("[Wavelet Engine] Initiating Morlet Wavelet Transform Analysis on VIX Aftershocks...")
    ...
    print(f"[Wavelet Engine] Data loaded: 2019-2021 (Targeting the massive 2020 COVID Crash).")
    ...
    if crash_idx + aftershock_window < len(vix_vals):
        ...
        print(f"During the extreme 30-day Post-Crash aftermath, the VIX oscillated with a dominant, repeating ripple period of exactly: {dominant_width} Trading Days.")
        ...
        print(f"For comparison, during the quiet, stable Bull Market of 2019, the dominant Volatility ripple period collapsed down to a baseline of: {quiet_width} Trading Days.")
        print(f"============================================================\n")
