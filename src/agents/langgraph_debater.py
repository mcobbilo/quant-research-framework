...
def macro_chief_node(state: DebateState) -> Dict[str, Any]:
    return {
        "macro_chief_analysis": "Evaluating broad market macro conditions. Base-case trend appears stable."
    }


def risk_manager_node(state: DebateState) -> Dict[str, Any]:
    return {
        "risk_manager_analysis": "Volatility looks bounded within historical norms. Capital allocation limits enforced."
    }
